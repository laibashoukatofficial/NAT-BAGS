...
$(document).ready(function () {
    ...
    $("#max_price").on("blur", function () {
        ...
        if (current_price < parseInt(min_price) || current_price > parseInt(max_price)) {
            ...
            alert("Price must between PKR" + min_price + ' and PKR' + max_price)
            $(this).val(min_price)
            $('#range').val(min_price)
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.bool === true) {
                    ...
                    updateWishlistCount();  // Update wishlist count after adding
                }
            },
    ...
    $(document).on('click', '.delete-wishlist-product', function(e) {
        e.preventDefault();
        var wishlistProductId = $(this).data('wishlist-product');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.bool === true) {
                    ...
                    updateWishlistCount();  // Update wishlist count after removal
                    // Update the wishlist view if needed
                }
            },
            error: function(xhr, status, error) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.wishlist_count !== undefined) {
                    ...
                    // Update any other UI elements related to wishlist count
                }
            },
            error: function(xhr, status, error) {
